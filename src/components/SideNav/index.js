 ...
 return(
        ...
        <div className="price-filter-container">
         ...
         <div>
            ...
            <button className='btn btn-outline-dark  my-3' onClick={() => params.setSortDetails("name")}> Sort by Name</button>
            <button className='btn btn-outline-dark  my-3' onClick={() => params.setSortDetails("price")}> Sort by Price</button>
